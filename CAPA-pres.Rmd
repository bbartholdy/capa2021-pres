...
<!--
# Exploring Dental Calculus and Diet Through an Oral Biofilm Model

**Bjørn Peare Bartholdy and Amanda G. Henry**

CAPA-ACAP 2021

.pull-right[
.bottom[
`r fontawesome::fa("link")` [HARVEST Project](harvestproject.eu)
]
]-->
---
class: bottom, right
...
.right-column[
.center[
Slides available (with source code):

<https://osf.io/5fbxw/>

Data and code available: [GitHub and OSF placeholder]
